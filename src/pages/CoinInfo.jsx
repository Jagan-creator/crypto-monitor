...
const CoinPage = () => {
  ...
  // Get the coinId from the route parameters
  const params = useParams();

  // API endpoint for fetching coin data
  const url = `https://api.coingecko.com/api/v3/coins/${params.coinId}?localization=false&sparkline=true`;

  // Effect hook to fetch coin data when component mounts
  useEffect(() => {
  ...
  return (
    <div className="rounded-div my-12 py-8">
      ...
      {/* Coin Price and Sparkline Section */}
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          ...
          <div>
            {/* Sparkline for 7-day price trend */}
      ...
      <div className="py-4">
        ...
        {/* Render sanitized HTML for coin description */}
        <p
